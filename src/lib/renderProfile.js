...
export function createRenderProfile({
  ...
  return {
    ...
    simpleTransition: isConstrainedMobile,
    skipSceneCapture: isConstrainedMobile,
    disableAo: isConstrainedMobile,
    disableBloom: isConstrainedMobile,
    disableChromaticAberration: isConstrainedMobile,
    disableLensDistortion: isConstrainedMobile,
    disableVignette: isConstrainedMobile,
    ...
    disableWildflowers: isConstrainedMobile,
    disableSkyClouds: isConstrainedMobile,
    grassBladeCountCap: isConstrainedMobile ? 1200 : null,
    disableGrassWind: isConstrainedMobile,
    backgroundLowCost: isConstrainedMobile,
    disableCatOutlines: isConstrainedMobile,
    disableCatAccentLights: isConstrainedMobile,
    disableObstacleContactShadows: isConstrainedMobile,
    disableHoldSign: isConstrainedMobile,
    disableIntroScreenGlow: isConstrainedMobile,
