...
| `TvScreen.jsx` | Curved screen mesh + canvas texture + CRT shader; pointer/keyboard start. |
| `tvScreenCanvas.js` | 2D canvas drawing for the attract-mode UI (title, HUD, EQ, button). |
