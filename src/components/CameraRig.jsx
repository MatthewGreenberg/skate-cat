...
export default function CameraRig({
  ...
  const {
    ...
    'Mobile Landscape': folder({
      ...
      resultsMobileBack: { value: -2.4, min: -3, max: 3, step: 0.05 },
      ...
      failedMobileBack: { value: -2.4, min: -3, max: 3, step: 0.05 },
      failedMobileFov: { value: -3, min: -20, max: 20, step: 0.5 },
      failedMobileLookX: { value: 0.06, min: -2, max: 2, step: 0.02 },
      failedMobileLookY: { value: 0.36, min: -2, max: 2, step: 0.02 },
      failedMobileLookZ: { value: 0, min: -2, max: 2, step: 0.02 },
      leaderboardMobileBack: { value: -2.4, min: -3, max: 3, step: 0.05 },
